 ...
 * Use for data that needs to be recomputed each round (ex. # of soldiers alive this round).
 * BiCHANNEL alternate between two channels. Use Comms.getCounterChannel() to get the update or read (lagging) channel.
 */
public enum BiCHANNEL {
    ...
    final CHANNEL ch1;
    final CHANNEL ch2;
    BiCHANNEL(CHANNEL ch1, CHANNEL ch2) { this.ch1 = ch1; this.ch2 = ch2; }
}
