...
public class Comms {
    ...
    public static final int MINING_TARGET_RESET_INTERVAL = 7;
    public static final int SOLDIER_TARGET_RESET_INTERVAL = 3;
    ...
    public void clearTargetAreas() throws GameActionException {
        if (round_num % SOLDIER_TARGET_RESET_INTERVAL == 0) {
    ...
    public void clearMiningAreas() throws GameActionException {
        if (round_num % MINING_TARGET_RESET_INTERVAL == 0) {
            for (int i = 0; i < 5; i++) {
    ...
    /*
     * public int getArchonNum(int num_archons_init, int num_archons_alive, int
     * archonNumber) throws GameActionException {
     * // none dead
     ...
     * }
     * // if 4 archons alive, binary sum is 3, if 3 archons alive, binary sum is
     * 2...
     * return binary_sum;
     * }
     * }
